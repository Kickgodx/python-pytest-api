...
class PetAPI(CustomRequester):
    ...
    def delete_pet(self, client: Client, pet_id):
        return self.delete(Router.DELETE_PET.format(pet_id=pet_id), headers=client.get_base_headers())
    ...
    def post_upload_image(self, client: Client, pet_id, additional_metadata: str, file):
        ...
        return self.post(Router.POST_UPLOAD_IMAGE.format(pet_id=pet_id), files=file, params=params, headers=client.get_base_headers())
    ...
    def post_update_status_and_name(self, client: Client, pet_id, name, status):
        ...
        return self.post(Router.POST_UPDATE_STATUS_AND_NAME.format(pet_id=pet_id), params=params, headers=client.get_base_headers())
