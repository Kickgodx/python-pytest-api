...
class StoreAPI(CustomRequester):
    ...
    def get_order_by_id(self, client: Client, order_id: int):
        ...
        return self.get(Router.GET_FIND_PURCHASE_ORDER_BY_ID.format(order_id=order_id), headers=client.get_base_headers())
    ...
    def delete_order_by_id(self, client: Client, order_id: int):
        ...
        return self.delete(Router.DELETE_DELETE_PURCHASE_ORDER_BY_ID.format(order_id=order_id), headers=client.get_base_headers())
